...
SequenceGenerator.controller('SettingCtrl', ['$scope', '$location', 'CourseList', 'SelectedCourses', function ($scope, $location, CourseList, SelectedCourses) {
    ...
    $scope.semester;
    if (SelectedCourses.semester == 1)
        $scope.semester = 'Fall';
    else if (SelectedCourses.semester == 2)
    ...
    $scope.generate = function () {
        ...
        if (ready) {
            $scope.$watch('courseID', function () {
                ...
                SelectedCourses.credits = $scope.totalCredits;
            });
