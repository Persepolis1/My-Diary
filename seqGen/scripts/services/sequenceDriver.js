SequenceGenerator.service('sequenceDriver', ['WebSequence', 'userPreferences', 'sequenceAlgorithms', function (WebSequence, userPreferences, sequenceAlgorithms) {
    //UI stuff
    ...
    //total credits
    var currentCredits = userPreferences.credits;
    ...
    /**
        ...
        4 = summer second
    **/
    var semester = userPreferences.semester;
    var pace = userPreferences.pace;
